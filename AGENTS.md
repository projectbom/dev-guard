...
- Next Codex session: use `.devguard/context/agent-context.md`, `.devguard/reports/project-handoff.md`, or `.devguard/prompts/next-codex-prompt.md` to resume without rediscovering the repo.
